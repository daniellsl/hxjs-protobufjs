...
@:jsRequire("protobufjs", "FieldBase") extern class FieldBase extends ReflectionObject {
	...
	**/
	function new(name:String, id:Float, type:String, ?rule:ts.AnyOf2<String, haxe.DynamicAccess<Dynamic>>, ?extend:ts.AnyOf2<String, haxe.DynamicAccess<Dynamic>>, ?options:haxe.DynamicAccess<Dynamic>, ?comment:String);
	/**
		Field rule, if any.
	**/
	@:optional
