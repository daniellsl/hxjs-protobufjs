...
@:jsRequire("protobufjs", "NamespaceBase") extern class NamespaceBase extends ReflectionObject {
	...
	**/
	@:optional
	public var nested : haxe.DynamicAccess<ReflectionObject>;
	/**
	...
	**/
	public function addJSON(nestedJson:haxe.DynamicAccess<AnyNestedObject>):Namespace;
	/**
	...
	**/
	public function getEnum(name:String):haxe.DynamicAccess<Float>;
	/**
