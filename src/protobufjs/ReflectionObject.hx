...
@:jsRequire("protobufjs", "ReflectionObject") extern class ReflectionObject {
	...
	**/
	@:optional
	public var options : haxe.DynamicAccess<Dynamic>;
	/**
		Parsed Options.
	**/
	@:optional
	public var parsedOptions : haxe.DynamicAccess<Array<Dynamic>>;
	/**
	...
	**/
	public function setOptions(options:haxe.DynamicAccess<Dynamic>, ?ifNotSet:Bool):ReflectionObject;
	/**
