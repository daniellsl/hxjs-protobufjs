...
@:jsRequire("protobufjs", "Type") extern class Type_ extends NamespaceBase {
	...
	**/
	...
	/**
		Message fields.
	**/
	public var fields : haxe.DynamicAccess<Field>;
	/**
		Oneofs declared within this namespace, if any.
	**/
	public var oneofs : haxe.DynamicAccess<OneOf>;
	/**
	...
	**/
	public final fieldsById : Array<Field>;
	/**
	...
	**/
	public function create(?properties:haxe.DynamicAccess<Dynamic>):Message<{ }>;
	/**
	...
	**/
	public function encode(message:ts.AnyOf2<Message<{ }>, haxe.DynamicAccess<Dynamic>>, ?writer:Writer):Writer;
	/**
		Encodes a message of this type preceeded by its byte length as a varint. Does not implicitly {@link Type#verify|verify} messages.
	**/
	public function encodeDelimited(message:ts.AnyOf2<Message<{ }>, haxe.DynamicAccess<Dynamic>>, ?writer:Writer):Writer;
	/**
	...
	**/
	public function verify(message:haxe.DynamicAccess<Dynamic>):Null<String>;
	/**
		Creates a new message of this type from a plain object. Also converts values to their respective internal types.
	**/
	public function fromObject(object:haxe.DynamicAccess<Dynamic>):Message<{ }>;
	/**
		Creates a plain object from a message of this type. Also converts values to other types if specified.
	**/
	public function toObject(message:Message<{ }>, ?options:IConversionOptions):haxe.DynamicAccess<Dynamic>;
