...
@:jsRequire("protobufjs", "util") @valueModuleOnly extern class Util {
	...
	**/
	static function merge(dst:haxe.DynamicAccess<Dynamic>, src:haxe.DynamicAccess<Dynamic>, ?ifNotSet:Bool):haxe.DynamicAccess<Dynamic>;
	/**
	...
	**/
	static function toArray(object:haxe.DynamicAccess<Dynamic>):Array<Dynamic>;
	/**
		Converts an array of keys immediately followed by their respective value to an object, omitting undefined values.
	**/
	static function toObject(array:Array<Dynamic>):haxe.DynamicAccess<Dynamic>;
	/**
	...
	**/
	static function setProperty(dst:haxe.DynamicAccess<Dynamic>, path:String, value:Dynamic):haxe.DynamicAccess<Dynamic>;
	/**
	...
	**/
	static var fs : haxe.DynamicAccess<Dynamic>;
	/**
