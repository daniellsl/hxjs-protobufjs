...
@:jsRequire("protobufjs", "Field") extern class Field extends FieldBase {
	...
	**/
	function new(name:String, id:Float, type:String, ?rule:ts.AnyOf2<String, haxe.DynamicAccess<Dynamic>>, ?extend:ts.AnyOf2<String, haxe.DynamicAccess<Dynamic>>, ?options:haxe.DynamicAccess<Dynamic>);
	/**
