...
@:jsRequire("protobufjs", "Method") extern class Method extends ReflectionObject {
	...
	**/
	function new(name:String, type:Null<String>, requestType:String, responseType:String, ?requestStream:ts.AnyOf2<Bool, haxe.DynamicAccess<Dynamic>>, ?responseStream:ts.AnyOf2<Bool, haxe.DynamicAccess<Dynamic>>, ?options:haxe.DynamicAccess<Dynamic>, ?comment:String, ?parsedOptions:haxe.DynamicAccess<Dynamic>);
	/**
		Method type.
	**/
